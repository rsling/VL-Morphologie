...
\begin{frame}
  ...
  \begin{exe}
    ...
    \begin{xlist}
      \ex arabesk, balladesk, burlesk, clownesk, gigantesk, karnevalesk, karrikaturesk, pittoresk, romanesk
      \ex chaplinesk, dantesk, donjuanesk, godardesk, goyaesk, hoffmannesk, kafkaesk, zappaesk
    \end{xlist}
    \onslide<+->
    \ex \alert{Adjektive auf ös}
    \begin{xlist}
      \ex bravourös, desaströs, fibrös, medikamentös, monströs, nervös, pompös, porös, ruinös, schikanös, skandalös, venös, virös
      \ex graziös, infektiös, minutiös, sentenziös, tendenziös
      \ex bituminös, libidinös, mirakulös, muskulös, nebulös, tuberkulös, voluminös
      \ex leprös, kariös, dubiös, ingeniös, kapriziös, luxuriös, melodiös, mysteriös
    \end{xlist}
  \end{exe}
  \onslide<+->
  \Viertelzeile
...
\begin{frame}
  ...
  \begin{exe}
    ...
    \begin{xlist}
      \ex Blamage, Karambolage, Massage, Montage, Passage, Reportage, Sabotage, Spionage
      \ex Bandage, Collage, Dränage, Etage, Garage, Passage, Plantage, Reportage, Trikotage
    \end{xlist}
    \onslide<+->
    \ex \alert{Substantive auf eur}
    \begin{xlist}
      \ex Akteur, Bankrotteur, Charmeur, Kontrolleur, Parfümeur, Rechercheur
      \ex Arrangeur, Chauffeur, Deserteur, Flaneur, Friseur, Hasardeur, Hypnotiseur, Jongleur, Kommandeur, Masseur, Monteur, Saboteur, Souffleur
      \ex Installateur, Konstrukteur, Operateur, Provokateur, Redakteur, Restaurateur, Spediteur
    \end{xlist}
  \end{exe}
  \onslide<+->
  \Viertelzeile
