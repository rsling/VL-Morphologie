  ...
  \begin{itemize}[<+->]
    \item Kombinatorik für \alert{Wortbestandteile} | Morphologie
      \begin{itemize}[<+->]
        ...
        \item oder \alert{Ablaut} | \textit{h\gruen{e}ben} -- \textit{h\gruen{o}b}
      \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item Demnach gäbe es \rot{eine Wortklasse}.
      \Zeile
    \item Genausogut könnte man sagen: Jedes Wort hat \alert{individuelle Eigenschaften}.
    \item Demnach gäbe es \rot{so viele Wortklassen wie Wörter}.
      \Zeile
