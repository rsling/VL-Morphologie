...
\begin{frame}
  {Nominalflexion analysieren}
  \onslide<+->
  \begin{itemize}[<+->]
    \item Suchen Sie im gegebenen Text nach Substantiven und bestimmen Sie ihre Flexionsklasse.
    \item Finden Sie Artikel und Pronomina und entscheiden Sie, ob das jeweils gegebene Wort ein Artikel oder ein Pronomen ist.
  \end{itemize}
\end{frame}
