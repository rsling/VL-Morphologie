...
\begin{frame}
  ...
  \Zeile
  \begin{itemize}[<+->]
    \item \alert{Nominalphrasen} haben \orongsch{Nomina} als Köpfe
      \begin{itemize}[<+->]
      ...
      \end{itemize}
      \Halbzeile
    \item \alert{Adjektivphrasen} haben \orongsch{Adjektive} als Köpfe
      \begin{itemize}[<+->]
      ...
      \end{itemize}
      \Halbzeile
    \item \alert{Präpositionalphrasen} haben \orongsch{Präpositionen} als Köpfe
      \begin{itemize}[<+->]
