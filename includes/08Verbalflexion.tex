...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item Flexion stark\slash schwach
      ...
      \end{itemize}
    \Zeile
    \item \citet[Kapitel~9.4, 10]{Schaefer2018b}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    \item Adjektive
      \begin{itemize}[<+->]
        \item Suchen Sie im gegebenen Text nach attributiven Adjektiven.
        \item Flektieren sie adjektival oder pronominal? Was ist der Auslöser dafür?
      \end{itemize}
      \Zeile
    \item Verben
      \begin{itemize}[<+->]
        \item Suchen Sie nach Vollverben im Text.
